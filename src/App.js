...
import OddBrewPage from "./components/OddBrewPage";
...
const icons = {
  ...
  oddbrew: <path d="M4 3h16v2H4zm1 4h14l-1.5 12.5A2 2 0 0 1 15.5 21h-7a2 2 0 0 1-1.99-1.5L5 7zm3.5 3 .6 8h6.8l.6-8H8.5z" />,
};
...
const NAV = [
  ...
  { section: "OddBrew" },
  { key: "oddbrew", label: "OddBrew", icon: "oddbrew" },
  { section: "Team" },
        ...
        <div className="me">
          ...
          <div className="who">
            ...
            {user.badges && user.badges.length ? (
              <div style={{ marginTop: 2 }}><RoleBadges badges={user.badges} size={9.5} /></div>
            ) : (
